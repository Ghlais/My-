...
client.on('ready', () => {
  ...
  let status = [`𝖡𝗒 Black Team`,`${prefix}help`];
  setInterval(()=>{
...
const owner = ["546983632720625674","791265722356465677"]///owner id
const supportServer = "https://discord.gg/offerstown"///server support
...
client.on('message', message => {
  ...
  if (message.channel.id !== 'id channel tax') return;
...
message.lineReply(`
> \`-\` **My Link :** https://discord.gg/offerstown
...
///black team up by Wanted and Mor3eb
